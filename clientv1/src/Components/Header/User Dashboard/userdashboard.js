...
export function Userdashboard(){
    ...
    useEffect(()=>{
        fetch("http://localhost:2611/user/"+fid)
        .then(res=>res.json())
        .then((data)=>{
  ...
  <img src="https://dailyonlineoffer.com/blog/wp-content/uploads/2022/04/Flipkart-logo-removebg-preview-1.png" class="d-block w-25" alt="..."/>
  <h4>Hi {fname} 👋!</h4>
